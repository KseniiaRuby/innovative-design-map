...
const ProjectDescription = ({
   ...
   return (
      <div className="border project-description project-padding">
         ...
         <br />
         <br />
         The project was <CheckIfHasValue value={projectFirm}> designed by <u>{projectFirm}</u> and</CheckIfHasValue> completed in{" "}
         <u>{projectYear}</u> <CheckIfHasValue value={projectClient}>for the</CheckIfHasValue> <u>{projectClient}</u>
      </div>
   )
}
